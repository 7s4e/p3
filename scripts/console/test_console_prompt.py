...
@pytest.mark.parametrize(
    ...
    [(None,                    False,                   False,                   False,                   None,                    TypeError), 
     ...
     (classmethod(mock_con),   False,                   False,                   False,                   None,                    TypeError), 
     ...
     (filter(mock_con, str()), False,                   False,                   False,                   None,                    TypeError), 
     ...
     (map(mock_con, str()),    False,                   False,                   False,                   None,                    TypeError), 
     ...
     (staticmethod(mock_con),  False,                   False,                   False,                   None,                    TypeError), 
    ...
    # prmt                     exp_key                  val_bool                 val_int                  int_val                  excep"
     ...
     ("",                      map(mock_con, str()),    False,                   False,                   None,                    TypeError), 
     ...
     ("",                      staticmethod(mock_con),  False,                   False,                   None,                    TypeError), 
    ...
    # prmt                     exp_key                  val_bool                 val_int                  int_val                  excep"
     ...
     ("",                      False,                   map(mock_con, str()),    False,                   None,                    TypeError), 
     ...
     ("",                      False,                   staticmethod(mock_con),  False,                   None,                    TypeError), 
    ...
    # prmt                     exp_key                  val_bool                 val_int                  int_val                  excep"
     ...
     ("",                      False,                   False,                   map(mock_con, str()),    None,                    TypeError), 
     ...
     ("",                      False,                   False,                   staticmethod(mock_con),  None,                    TypeError), 
    ...
    # prmt                     exp_key                  val_bool                 val_int                  int_val                  excep"
     ...
     ("",                      False,                   False,                   True,                    map(mock_con, str()),    TypeError), 
     ...
     ("",                      False,                   False,                   True,                    staticmethod(mock_con),  TypeError), 
...
def test_constructor(mock_con, prmt, exp_key, val_bool, val_int, int_val, excep):
...
# def test_constructor_value_errors(mock_con, prmt, exp_key, val_bool, val_int, int_val, excep):
